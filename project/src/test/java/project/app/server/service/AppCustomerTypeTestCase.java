...
public class AppCustomerTypeTestCase {
    ...
    public void test1Save() {
        try {
            ...
            appcustomertype.setCustomerType("hilTK726MxQvfxZX8HlDdjEKsP1otpNXsLYEjfq0dfaoI1bUSM");
    ...
    public void test2Update() {
        try {
            ...
            appcustomertype.setCustomerType("zKzOKHPlLfdPFAf8Zp9zcDuK58pd9qnnHtQXSMsMZLgCmnh3Fn");
            appcustomertype.setDefaults(1);
            appcustomertype.setSequenceId(2147483647);

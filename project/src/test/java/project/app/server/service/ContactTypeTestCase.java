...
public class ContactTypeTestCase {
    ...
    public void test1Save() {
        try {
            ...
            contacttype.setContactType("GVoxylybYxQsHbmqUONycJ5oxXB9T3S9DmvFjDLFU02y9ypGyU");
            contacttype.setContactTypeDesc("ELeDtNgulaQQQqH0MqaEQqqmaCjsnTAhcy4bs7FVWv4xoTzJfN");
            contacttype.setContactTypeIcon("pjSUiWxRQEOIXFymgOxrICm70Ju5Tuf8QW1PExU5T1WblR570k");
    ...
    public void test2Update() {
        try {
            ...
            contacttype.setContactType("8VD5aSd5UKXrZzZFVo8hqM0OjwMtsJkAV3JBvx2URK7FMYddWg");
            contacttype.setContactTypeDesc("2z7FtKaEBMRfa0eKkElxfsHFtdBSobgJrAgXPqr04PD8QvKK6z");
            contacttype.setContactTypeIcon("fi8whn4tX47C6ZoSwcVhFEPIzM4zRuPiBewvywneCLWdQFdOET");

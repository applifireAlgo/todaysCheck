...
public class QuestionTestCase {
    ...
    public void test1Save() {
        try {
            ...
            question.setQuestion("5cZoRjcaHbBoOFWeUSikbFn6yTzO6au0V8Vpdmav0qLB0ANPyi");
            question.setQuestionDetails("i");
            question.setQuestionIcon("EXAJFS0BOdL6goaJ4ooJJcS4gZsz3IiuHvkeWHLTAsyxgwkiYe");
    ...
    public void test2Update() {
        try {
            ...
            question.setQuestion("3G5aCf02QSfrt8qFpDwa71jRpPHxRVK0IxQSbBJ4TuSZHHqbdF");
            question.setQuestionDetails("V");
            question.setQuestionIcon("qJbrPE6Hn8HO1DmoPP9eYQhnIT55wVcIt4WTWlokwID7XId8P1");

...
public class CurrencyTestCase {
    ...
    public void test1Save() {
        try {
            ...
            country.setCapital("UKxlbG2gXDfH0Ksi7IkNoy7pW1Jaby2a");
            country.setCapitalLatitude(3);
            country.setCapitalLongitude(6);
            country.setCountryCode1("W3J");
            country.setCountryCode2("47L");
            country.setCountryFlag("fvM9NLGGrN4kwO3lrq0DLnI9W1e3LSns0F8rBELSZj98EDAGJn");
            country.setCountryName("qRfE5IS9B2sxPDvEe5YRORA6jYfxSUoWPPAckJsQd23Dm7KzP9");
            country.setCurrencyCode("Fkq");
            country.setCurrencyName("o9KLHET519dvsqJRexm78MHy9eCZvm1kT9vNayGDVHjjh6uJ07");
            country.setCurrencySymbol("lfN7OR7bGjvUr5GvBOl30CvXEQHxsSIw");
            country.setIsoNumeric(5);
            Country CountryTest = countryRepository.save(country);
            map.put("CountryPrimaryKey", country._getPrimarykey());
            Currency currency = new Currency();
            currency.setCountryId((java.lang.String) CountryTest._getPrimarykey());
            currency.setCurrencyCode("fF8uhRHO5SPOBftqcbsLxQ8mvPsFm3ixWiPF0TS9fH1XGxbPMb");
            currency.setUnicodeDecimal("4DWSKhUcSrRZ8yuIuhKtqCarjRMJDRlpEvWMlJRGIpuwaRZAzL");
            currency.setUnicodeHex("Lfx8YfTgkRXc9GK5rYOlMr1MGOBGFg7lC12rBQoqi2R0gHOP54");
    ...
    public void test2Update() {
        try {
            ...
            currency.setCurrencyCode("3r7Ljx844uwOVUXXiXJMIefiBKACh8h0uBieKJBUdPN14UD4DI");
            currency.setUnicodeDecimal("sS64B2KdWImP0Vwz31pNEE6JCvjeN3T2Ij9zB7LhcWp9hzud7q");
            currency.setUnicodeHex("3BUQw98lrLsYG0AGTlG78ZtanU9oajSPOh9OAptZB8TszFnCOH");

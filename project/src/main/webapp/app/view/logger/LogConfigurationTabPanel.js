...
Ext
		.define(
				'Project.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Project.view.logger.tabs.details.DetailsTab',
							'Project.view.logger.tabs.fileconnector.FileConnectorTab',
							'Project.view.logger.tabs.dbconnector.DBConnectorTab',
							'Project.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Project.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Project.view.logger.LogConfigurationTabPanelController',

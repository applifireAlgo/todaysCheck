 ...
 * 
 */
Ext.define('Project.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Project.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],

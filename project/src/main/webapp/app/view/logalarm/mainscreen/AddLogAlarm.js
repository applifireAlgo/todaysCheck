 ...
 * 
 */
Ext.define('Project.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Project.view.logalarm.mainscreen.AddLogAlarmController',
			'Project.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Project.view.logalarm.mainscreen.AppAlarmPanel',

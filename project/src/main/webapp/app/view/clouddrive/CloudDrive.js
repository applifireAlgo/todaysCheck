Ext.define("Project.view.clouddrive.CloudDrive", {
	extend : 'Ext.panel.Panel',
	xtype : 'clouddrive',
	requires : [ 'Project.view.clouddrive.CloudDriveController',
	             'Project.view.clouddrive.documentview.DocumentsView',
	             'Project.view.clouddrive.drivedetails.DriveDetails',
	             //'Project.view.clouddrive.documentview.DocumentListView'
	             ],

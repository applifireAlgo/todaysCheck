 ...
 * 
 */
Ext.define('Project.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Project.view.securityconfig.SecurityConfigController',
			'Project.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',

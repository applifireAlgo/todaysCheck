...
Ext.define('Project.view.reportui.datachart.chart.RatingField', {
	...
	onRender: function(ct, position) {
		Project.view.reportui.datachart.chart.RatingField.superclass.onRender.call(this, ct, position);
	 ...
	 */
	initEvents: function() {
		Project.view.reportui.datachart.chart.RatingField.superclass.initEvents.call(this);

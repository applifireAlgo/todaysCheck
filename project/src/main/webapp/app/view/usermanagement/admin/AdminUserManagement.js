Ext.define('Project.view.usermanagement.admin.AdminUserManagement', {
	extend : 'Ext.tab.Panel',
	requires : ['Project.view.usermanagement.admin.UserPasswordReset',
	            'Project.view.usermanagement.admin.AddUserDetails',
	            'Project.view.usermanagement.admin.ViewUser'],

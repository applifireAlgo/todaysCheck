 ...
 */
Ext.define('Project.view.fw.component.DateTimeField', {
    extend: 'Ext.form.field.Date',
    alias: 'widget.customdatetimefield',
    xtype : 'customdatetimefield',
    requires: ['Project.view.fw.component.DateTimePicker'
               ],
    ...
    createPicker: function() {
        ...
        return new Project.view.fw.component.DateTimePicker(o);
    },

Ext.define('Project.view.reportbuilder.reportBuilder.ReportConfigurationView', {
	extend : 'Ext.panel.Panel',
	requires: ['Project.view.reportbuilder.querycriteria.QueryCriteriaView',
	           'Project.view.reportbuilder.gridconfig.GridConfigView',
	           'Project.view.reportbuilder.properties.PropertiesPanelView',
	           'Project.view.reportbuilder.sql.SqlListPanelView'],
    xtype:'report-config',
   	layout:'border', 
   	items:[
   	       {

Ext.define('Project.project.web.project.controller.defaultcontext.defaultdomain.TestEntityMainController', {
     ...
     onDeleteActionColumnClickMainGrid: function(grid, rowIndex) {
          var recordId = grid.store.data.items[rowIndex].data.entityId;
          me = this;

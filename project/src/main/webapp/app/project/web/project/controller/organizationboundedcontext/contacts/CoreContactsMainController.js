Ext.define('Project.project.web.project.controller.organizationboundedcontext.contacts.CoreContactsMainController', {
     extend: 'Project.view.fw.frameworkController.AggregateViewController',
